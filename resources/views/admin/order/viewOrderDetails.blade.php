        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background-color:#71cd14;">
                    <h4  style="color: #ffffff;">Order Details
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <h4>Grand Total: Rs.{{$total}}</h4><hr><br>
                            
                            <div class="col-md-3 order-status ml-20">
                                <form action="{{ url('update/order/status/'.$orders->id)}}" method="post">
                                    @csrf
                                    @method('PUT')    
                                    <h5>Orede Status</h5>
                                    ...
                                    <button type="submit" class="btn btn-success mt-2 float-end"><i class="fa-solid fa-floppy-disk"></i> Update</button>
                                </form>
                            </div>
